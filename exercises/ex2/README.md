...
## Exercise 2.1 Generate data model using Joule ✨📊

<br>__1.__ Open your project
-  __Click__ on __Guide Center__-icon in the left-side activity bar 
- Select __Generative AI-Powered Development__
<br>![](/exercises/ex2/images/1_guidecenter.png)

<br>__2.__ Within the __Generate AI-Powered Development__ view
-  Go to __Data Model and Service Creation__ and Click on __Open Joule__  
...
>💡 __Insight Corner__:SAP Joule in Build Code lets you use AI-driven commands like /cap-gen-model to quickly generate CAP models, services, and deployments, speeding up development with intelligent automation.
...
<br>__5.__ After a couple of seconds, you will see the __generated data model__, as suggested by the Joule assistant according to your previous textual instruction.

> __ℹ️ NOTE__: The file generated by Joule may not be identical for every user. The data model produced can vary between participants and may also differ from the screenshots shown in the documentation.
...
<br>__7.__  You should now see the updated storyboard, which includes the newly added Risk and Mitigation entities.

__[OPTIONAL]__ If the storyboard does not open automatically, follow the steps below.
- Open the Project __Storyboard__
- __Click__ on __Project Overview__-icon in the left-side activity bar
- From your project's context actions menu __⋯__, _select_ __Open Storyboard__ and you will see the newly generated data model and services.
...
- __Click__ on __Explorer__-icon in the left-side activity bar
- Open and review the files from the project tree i.e __'./db/schema.cds'__ and __'./srv/service.cds'__
<br>![](/exercises/ex2/images/8_project_explorer.png)
<br>![](/exercises/ex2/images/9_cdsfiles.png)

__[OPTIONAL]__ If you’d like to explore the code used in this tutorial, you can refer to the schema and service CDS definitions provided below.

>In the files __'schema.cds'__ and __'service.cds'__ above, replace U00 with the unique number assigned to you.
...
<br>__9.__ Go back to the __Generate AI-Powered Development__ tab
- Go to __Generate Sample Data__ > __Open Joule__. 
- Joule panel opens with the command __'/cap-gen-data'__.
- Select the entity context by typing #__ and then clicking '#db/schema.cds'. Next, enter the prompt text below.
...
- Review the data by clicking on the .csv files before accepting.
...
<br>__11.__ Go back to the joule panel and click on  __Open Data Editor__ & review the generated sample data. 
...
SAP Joule lets you create CAP-based data entities and OData services with contextual sample data with just one text prompt. 
